...
export class Backend implements backendInterface {
    ...
    async getSortedParticipantsByAvailability(): Promise<Array<Participant>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSortedParticipantsByAvailability();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateAvailability(arg0: string, arg1: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateAvailability(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
